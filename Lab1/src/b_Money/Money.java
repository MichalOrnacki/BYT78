...
public class Money implements Comparable {
	...
	public Money add(Money other) {
		Money newMoney = this;
		Integer convertedOther = (int)(other.universalValue()/this.currency.getRate());
		newMoney.amount += convertedOther;
		return newMoney;
	}
	...
	public int compareTo(Object other) {
		Money moneyCom = (Money)other;
		if(this.universalValue().equals(moneyCom.universalValue()))
			return 0;
		else if(this.universalValue() < moneyCom.universalValue())
			return -1;
		else return 1;
	}
}